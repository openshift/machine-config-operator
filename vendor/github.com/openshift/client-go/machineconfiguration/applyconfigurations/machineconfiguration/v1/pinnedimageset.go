...
// PinnedImageSetApplyConfiguration represents an declarative configuration of the PinnedImageSet type for use
// with apply.
...
// Experimental!
func ExtractPinnedImageSet(pinnedImageSet *apimachineconfigurationv1.PinnedImageSet, fieldManager string) (*PinnedImageSetApplyConfiguration, error) {
...
// Experimental!
func ExtractPinnedImageSetStatus(pinnedImageSet *apimachineconfigurationv1.PinnedImageSet, fieldManager string) (*PinnedImageSetApplyConfiguration, error) {
	return extractPinnedImageSet(pinnedImageSet, fieldManager, "status")
}

func extractPinnedImageSet(pinnedImageSet *apimachineconfigurationv1.PinnedImageSet, fieldManager string, subresource string) (*PinnedImageSetApplyConfiguration, error) {
	b := &PinnedImageSetApplyConfiguration{}
