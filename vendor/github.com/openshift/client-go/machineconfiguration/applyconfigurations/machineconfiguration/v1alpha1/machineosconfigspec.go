...
type MachineOSConfigSpecApplyConfiguration struct {
	...
	Rebuild           *MachineOSRebuildApplyConfiguration           `json:"rebuild,omitempty"`
}
...
func (b *MachineOSConfigSpecApplyConfiguration) WithRebuild(value *MachineOSRebuildApplyConfiguration) *MachineOSConfigSpecApplyConfiguration {
	b.Rebuild = value
	return b
}
