...
func (in *InternalReleaseImageStatus) DeepCopyInto(out *InternalReleaseImageStatus) {
	*out = *in
	if in.Releases != nil {
		in, out := &in.Releases, &out.Releases
		*out = make([]InternalReleaseImageStatusRef, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InternalReleaseImageStatusRef) DeepCopyInto(out *InternalReleaseImageStatusRef) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InternalReleaseImageStatusRef.
func (in *InternalReleaseImageStatusRef) DeepCopy() *InternalReleaseImageStatusRef {
	if in == nil {
		return nil
	}
	out := new(InternalReleaseImageStatusRef)
	in.DeepCopyInto(out)
	return out
}
