...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MachineConfigVersion) DeepCopyInto(out *MachineConfigVersion) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MachineConfigVersion.
func (in *MachineConfigVersion) DeepCopy() *MachineConfigVersion {
	if in == nil {
		return nil
	}
	out := new(MachineConfigVersion)
	in.DeepCopyInto(out)
	return out
}
