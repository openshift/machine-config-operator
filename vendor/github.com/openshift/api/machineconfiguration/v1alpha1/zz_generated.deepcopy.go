...
func (in *OSImageStreamStatus) DeepCopyInto(out *OSImageStreamStatus) {
	*out = *in
	if in.AvailableStreams != nil {
		...
		*out = make([]OSImageStreamURLSet, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OSImageStreamURLSet) DeepCopyInto(out *OSImageStreamURLSet) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OSImageStreamURLSet.
func (in *OSImageStreamURLSet) DeepCopy() *OSImageStreamURLSet {
	if in == nil {
		return nil
	}
	out := new(OSImageStreamURLSet)
	in.DeepCopyInto(out)
	return out
}
