...
type InternalReleaseImageSpec struct {
	...
	// This field can contain between 1 and 16 entries.
...
type InternalReleaseImageBundleStatus struct {
	...
	//
	// If Mounted is true, that means that a a valid ISO has been discovered and mounted on one of the cluster nodes.
