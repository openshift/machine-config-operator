...
var map_InternalReleaseImageSpec = map[string]string{
	...
	"releases": "releases is a list of release bundle identifiers that the user wants to add/remove to/from the control plane nodes. Entries must be unique, keyed on the name field. This field can contain between 1 and 16 entries.",
}
