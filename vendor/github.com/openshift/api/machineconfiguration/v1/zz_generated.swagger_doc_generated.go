...
var map_ControllerConfigSpec = map[string]string{
	...
	"internalRegistryPullSecret":     "internalRegistryPullSecret is the pull secret for the internal registry",
...
var map_MachineState = map[string]string{
	"": "MachineState describes the health of the Machines on the system\n\nCompatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).",
}

func (MachineState) SwaggerDoc() map[string]string {
	return map_MachineState
}

var map_MachineStateConfig = map[string]string{
	"": "MachineStateConfig describes the configuration of a MachineState",
}

func (MachineStateConfig) SwaggerDoc() map[string]string {
	return map_MachineStateConfig
}

var map_MachineStateList = map[string]string{
	"": "MachineStateList describes all of the MachinesStates on the system\n\nCompatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).",
}

func (MachineStateList) SwaggerDoc() map[string]string {
	return map_MachineStateList
}

var map_MachineStateSpec = map[string]string{
	"":                 "MachineStateSpec describes the type of State we are managing",
	"machineStateKind": "machineStateKind describes the type of MachineState",
	"configuration":    "configuration describes the object reference inforation of a MachineState",
}

func (MachineStateSpec) SwaggerDoc() map[string]string {
	return map_MachineStateSpec
}

var map_MachineStateStatus = map[string]string{
	"":                   "MachineStateStatus holds the reported information on a particular MachineState",
	"configuration":      "configuration Describes the Kind of MachineState",
	...
	"health":             "health reports the overall status of this MachineState Given its Progress",
}

func (MachineStateStatus) SwaggerDoc() map[string]string {
	return map_MachineStateStatus
}
...
var map_ProgressionHistory = map[string]string{
	...
	"nameAndType": "nameandType describes the name of the object",
	"state":       "state describes what is happening with this object",
	"phase":       "phase is the general action occuring",
	"reason":      "reason is a more detailed description of the phase",
}
