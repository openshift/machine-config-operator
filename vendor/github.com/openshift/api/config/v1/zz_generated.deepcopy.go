...
func (in *WorkerLatencyProfileStatus) DeepCopyInto(out *WorkerLatencyProfileStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]WorkerLatencyStatusCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkerLatencyStatusCondition) DeepCopyInto(out *WorkerLatencyStatusCondition) {
	*out = *in
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkerLatencyStatusCondition.
func (in *WorkerLatencyStatusCondition) DeepCopy() *WorkerLatencyStatusCondition {
	if in == nil {
		return nil
	}
	out := new(WorkerLatencyStatusCondition)
	in.DeepCopyInto(out)
	return out
}
