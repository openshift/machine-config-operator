...
func TestSyncMachineConfiguration(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			expectedSkewEnforcementStatus:   apihelpers.GetSkewEnforcementStatusAutomatic("4.18.0"),
		},
		{
		...
		},
		{
			...
			annotationExpected:              false,
			expectedManagedBootImagesStatus: apihelpers.GetManagedBootImagesWithUpdateEnabled(),
			expectedSkewEnforcementStatus:   apihelpers.GetSkewEnforcementStatusAutomatic("4.19.1"),
		},
		{
		...
		},
		{
			...
			annotationExpected:              false,
			expectedManagedBootImagesStatus: apihelpers.GetManagedBootImagesWithUpdateEnabled(),
			expectedSkewEnforcementStatus:   apihelpers.GetSkewEnforcementStatusAutomatic("4.17.0"),
		},
		{
