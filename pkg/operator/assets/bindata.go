...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: machine-config-controller
        image: quay.io/abhinavdahiya/machine-config-controller@sha256:aa421ff520626ccaecb56bc1c367200d22e4b137f3572ddcf330fdfd888b1050
        args:
        - "start"
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: machine-config-daemon
          image: quay.io/abhinavdahiya/machine-config-daemon@sha256:5df988a0909e125ed7a9c51d4b0f5c4f4fe3572ae1a95992e820bbccff636943
          args:
            - "start"
