...
func TestDefaultStreamSourceFactory_Create_UserDefaultOverride(t *testing.T) {
	imageStream := &imagev1.ImageStream{
		Spec: imagev1.ImageStreamSpec{
			Tags: []imagev1.TagReference{
				{
					Name: "rhel-coreos",
					From: &corev1.ObjectReference{Kind: "DockerImage", Name: "quay.io/openshift/os-9@sha256:aaa111"},
				},
				{
					Name: "rhel-9-coreos",
					From: &corev1.ObjectReference{Kind: "DockerImage", Name: "quay.io/openshift/os-9@sha256:aaa111"},
				...
				{
					Name: "rhel-9-coreos-extensions",
					From: &corev1.ObjectReference{Kind: "DockerImage", Name: "quay.io/openshift/ext-9@sha256:bbb222"},
				},
				{
					Name: "rhel-10-coreos",
					From: &corev1.ObjectReference{Kind: "DockerImage", Name: "quay.io/openshift/os-10@sha256:ccc333"},
				},
				{
					Name: "rhel-10-coreos-extensions",
					From: &corev1.ObjectReference{Kind: "DockerImage", Name: "quay.io/openshift/ext-10@sha256:ddd444"},
				},
			},
		},
	}
	...
	inspector := &mockImagesInspector{
		inspectData: map[string]*types.ImageInspectInfo{
			"quay.io/openshift/os-9@sha256:aaa111":  {Labels: map[string]string{"io.openshift.os.streamclass": "rhel-9", "ostree.linux": "present"}},
			"quay.io/openshift/ext-9@sha256:bbb222": {Labels: map[string]string{"io.openshift.os.streamclass": "rhel-9"}},
			"quay.io/openshift/os-10@sha256:ccc333":  {Labels: map[string]string{"io.openshift.os.streamclass": "rhel-10", "ostree.linux": "present"}},
			"quay.io/openshift/ext-10@sha256:ddd444": {Labels: map[string]string{"io.openshift.os.streamclass": "rhel-10"}},
		},
	}
	...
	assert.Equal(t, "rhel-9", result.Annotations[ctrlcommon.BuiltinDefaultStreamAnnotationKey], "annotation should preserve the builtin default")
