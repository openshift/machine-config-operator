...
type Interface interface {
	...
	Machineconfiguration() machineconfigurationv1.MachineconfigurationV1Interface
}
...
// Deprecated: Machineconfiguration retrieves the default version of MachineconfigurationClient.
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.machineconfigurationV1, err = machineconfigurationv1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.machineconfigurationV1 = machineconfigurationv1.NewForConfigOrDie(c)
