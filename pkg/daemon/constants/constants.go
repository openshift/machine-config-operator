...
const (
	...
	// MachineConfigDaemonRebootRequestedAnnotation is the MCD signaling that a node wants to reboot
	MachineConfigDaemonRebootRequestedAnnotation = "machineconfiguration.openshift.io/reboot-requested"
	// MachineConfigDaemonRebootApprovedAnnotation is added by the MCC to signal approval to reboot
	...
	// RequestRebootJournalMessageID is written by `machine-config-daemon request-reboot` into the journal.
	// It was generated by `systemd-id128 new`.
	RequestRebootJournalMessageID = "bebd48754ea1425ab458bb22693c696a"
