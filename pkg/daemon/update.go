...
// verifyExtensionsStaged verifies that all extension packages specified in a
// MachineConfig are staged in the rpm-ostree deployment before rebooting.
// This catches issues early, before the node reboots and potentially fails to boot.
// See: https://redhat.atlassian.net/browse/OCPBUGS-65645
