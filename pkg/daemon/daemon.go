...
func (dn *Daemon) triggerUpdateWithMachineConfig(node *corev1.Node, currentConfig *mcfgv1.MachineConfig, desiredConfig *mcfgv1.MachineConfig) error {
	if currentConfig == nil {
		...
		if err != nil {
			return errors.Wrapf(errTransient, "failed to get machineconfigs for %q: %v", ccAnnotation, err)
		}
	}
	...
	if desiredConfig == nil {
		...
		if err != nil {
			return errors.Wrapf(errTransient, "failed to get machineconfigs for %q: %v", dcAnnotation, err)
		}
	}
