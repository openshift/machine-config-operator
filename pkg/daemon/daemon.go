...
const (
	...
	// TODO: This should probably come from rpm-ostree as the source of truth in
	// the future.
...
// purpose is similar to the /etc/machine-config-daemon/currentconfig file. In
// the future, I'd like to remove the need for this file and base this solely
// off of the currently booted rpm-ostree deployment.
