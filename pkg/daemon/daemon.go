...
func (dn *Daemon) getUnsupportedPackages() {
	...
	allPackageChanges :=
		append(activeDeployment.RequestedPackages,
			append(activeDeployment.RequestedLocalPackages,
				append(activeDeployment.RequestedLocalFileoverridePackages,
					append(activeDeployment.RequestedBaseRemovals, activeDeployment.RequestedBaseLocalReplacements...)...)...)...)
