...
// GetSkewEnforcementStatusAutomatic returns a BootImageSkewEnforcementStatus with Automatic mode and the given OCP version.
func GetSkewEnforcementStatusAutomatic(ocpVersion string) opv1.BootImageSkewEnforcementStatus {
