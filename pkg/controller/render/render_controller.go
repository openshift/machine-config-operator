...
func (ctrl *Controller) Run(workers int, stopCh <-chan struct{}) {
	...
	if !cache.WaitForCacheSync(stopCh, ctrl.mcpListerSynced, ctrl.mcListerSynced, ctrl.ccListerSynced, ctrl.osImageStreamListerSynced) {
		return
	}
...
func (ctrl *Controller) getOSImageStreamForPool(pool *mcfgv1.MachineConfigPool) (*v1alpha1.OSImageStreamSet, error) {
	...
	imageStream, err := ctrl.osImageStreamLister.Get(osimagestream.ClusterInstanceNameOSImageStream)
	if err != nil {
