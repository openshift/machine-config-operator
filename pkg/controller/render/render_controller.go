...
func (ctrl *Controller) getRenderedMachineConfig(pool *mcfgv1.MachineConfigPool, configs []*mcfgv1.MachineConfig, cc *mcfgv1.ControllerConfig) (*mcfgv1.MachineConfig, error) {
	...
	if ctrl.fgHandler.Enabled(features.FeatureGateIrreconcilableMachineConfig) {
	...
	return generateAndValidateRenderedMachineConfig(currentMC, pool, configs, cc, &mcop.Spec.IrreconcilableMachineConfigValidationOverrides)
}
...
func generateAndValidateRenderedMachineConfig(
	...
	validationOverrides *opv1.IrreconcilableMachineConfigValidationOverrides) (*mcfgv1.MachineConfig, error) {
	source := getMachineConfigRefs(configs)
