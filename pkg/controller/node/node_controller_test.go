...
func (f *fixture) newControllerWithStopChan(stopCh <-chan struct{}) *Controller {
	...
	c := NewControllerwithOCL(i.Machineconfiguration().V1().ControllerConfigs(), i.Machineconfiguration().V1().MachineConfigs(), i.Machineconfiguration().V1().MachineConfigPools(), k8sI.Core().V1().Nodes(),
