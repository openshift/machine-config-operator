...
func (p *pipelineImageBuilder) getStatus(ctx context.Context) (*tektonv1.PipelineRun, mcfgv1.BuildProgress, []metav1.Condition, error) {
...
func (p *pipelineImageBuilder) mapPipelineStatusToBuildStatus(pipelineRun *tektonv1.PipelineRun) (mcfgv1.BuildProgress, []metav1.Condition) {
