...
// Implement Me
func (j *jobImageBuilder) Exists(_ context.Context) (bool, error) { return false, nil }

// Implement Me
func (j *jobImageBuilder) Get(_ context.Context) (buildrequest.Builder, error) { return nil, nil }
