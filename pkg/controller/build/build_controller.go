...
func (ctrl *Controller) getConfigAndBuildFromBuildPodAnnotations(pod *corev1.Pod) (*mcfgv1alpha1.MachineOSConfig, *mcfgv1alpha1.MachineOSBuild, error) {
	mosc, err := ctrl.mcfgclient.MachineconfigurationV1alpha1().MachineOSConfigs().Get(context.TODO(), pod.ObjectMeta.Annotations[machineOSConfigNameAnnotationKey], metav1.GetOptions{})
	if err != nil {
		return nil, nil, err
	}
	mosb, err := ctrl.mcfgclient.MachineconfigurationV1alpha1().MachineOSBuilds().Get(context.TODO(), pod.ObjectMeta.Annotations[machineOSBuildNameAnnotationKey], metav1.GetOptions{})
	if err != nil {
		return nil, nil, err
	}
