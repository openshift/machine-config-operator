...
// Retrieves the secret for the MachineOSBuild and the ControllerConfig for use by the imagepruner.
func (b *buildReconciler) getObjectsForImagePruner(mosb *mcfgv1.MachineOSBuild) (*corev1.Secret, *mcfgv1.ControllerConfig, error) {
	...
	return secret, controllerConfigs[0], nil
}

// Retrieves the necessary objects and calls InspectImage on the imagepruner.
...
// Retrieves the necessary objects and calls DeleteImage on the imagepruner.
