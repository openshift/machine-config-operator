		...
		pipeline := &tektonv1beta1.Pipeline{
			...
			Spec: tektonv1beta1.PipelineSpec{
				Params: []tektonv1beta1.ParamSpec{
					...
					tektonv1beta1.ParamSpec{Name: "httpsProxy", Type: tektonv1beta1.ParamTypeString, Description: "proxy"},
					tektonv1beta1.ParamSpec{Name: "noProxy", Type: tektonv1beta1.ParamTypeString, Description: "proxy"},
				...
				Results: []tektonv1beta1.PipelineResult{
					tektonv1beta1.PipelineResult{Name: "IMAGE_DIGEST", Description: "Digest of the image just built", Value: tektonv1beta1.ResultValue{StringVal: "$(tasks.buildah-build.results.IMAGE_DIGEST)"}},
					tektonv1beta1.PipelineResult{Name: "IMAGE_URL", Description: "Image repository where the built image would be pushed to", Value: tektonv1beta1.ResultValue{StringVal: "$(tasks.buildah-build.results.IMAGE_URL)"}},
				},
				...
				Tasks: []tektonv1beta1.PipelineTask{
					...
					tektonv1beta1.PipelineTask{
						...
						Params: []tektonv1beta1.Param{
							...
							tektonv1beta1.Param{Name: "BUILD_ARGS", Value: tektonv1beta1.ArrayOrString{Type: tektonv1beta1.ParamTypeArray, ArrayVal: []string{"HTTP_PROXY=$(params.httpProxy)", "HTTPS_PROXY=$(params.httpsProxy)", "NO_PROXY=$(params.noProxy)"}}},
...
func (b *buildReconciler) startBuild(ctx context.Context, mosb *mcfgv1alpha1.MachineOSBuild) error {
	...
	case mcfgv1alpha1.PipelineBuilder:
		if err := imagebuilder.NewPipelineImageBuilder(b.kubeclient, b.mcfgclient, mosb, mosc).Start(ctx); err != nil {
			return fmt.Errorf("imagebuilder could not start build for MachineOSBuild %q: %w", mosb.Name, err)
		}
	default:
