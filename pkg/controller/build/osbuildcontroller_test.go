...
func setupOSBuildControllerForTest(ctx context.Context, t *testing.T) (*clients, *testhelpers.Assertions, *fixtures.LayeredObjectsForTest) {
	...
	kubeassert := testhelpers.Assert(t, clients.kubeclient, clients.mcfgclient).
		Eventually().
		WithContext(ctx).
