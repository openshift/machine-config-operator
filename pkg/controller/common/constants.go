...
const (
	...
	// ControlPlaneTaintKey defines the taint key associated with control-plane nodes
	...
	// the version references and figure out "was this supposed to be explicitly 3.6.0 or just the default version which happens
	// to be 3.6.0 currently". Ideally if you find an explicit "3.6.0", it's supposed to be "3.6.0" version. If it's this constant,
	// it's supposed to be the internal default version.
	InternalMCOIgnitionVersion = "3.6.0"
