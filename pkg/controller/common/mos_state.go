...
func (l *MachineOSConfigState) GetOSImage() string {
	osImage := l.Config.Spec.BuildInputs.FinalImagePullspec
	return osImage
}

// Determines if an OS image build is a success.
func (l *MachineOSBuildState) IsBuildSuccess() bool {
	return apihelpers.IsMachineOSBuildConditionTrue(l.Build.Status.Conditions, mcfgv1alpha1.MachineOSReady)
}
...
// Determines if an OS image build has failed.
func (l *MachineOSBuildState) IsBuildRestarted() bool {
	return apihelpers.IsMachineOSBuildConditionTrue(l.Build.Status.Conditions, mcfgv1alpha1.MachineOSBuildRestarted)
}
...
func (m *MachineOSConfigState) HasOSImage() bool {
	val := m.Config.Spec.BuildInputs.FinalImagePullspec
	return val != ""
}

// Clears the image pullspec annotation.
func (m *MachineOSConfigState) ClearImagePullspec() {
	m.Config.Spec.BuildInputs.FinalImagePullspec = ""
}
...
func getMachineConfigBuildConditions() []mcfgv1alpha1.BuildProgress {
	return []mcfgv1alpha1.BuildProgress{
		...
		mcfgv1alpha1.MachineOSBuildRestarted,
		mcfgv1alpha1.MachineOSReady,
