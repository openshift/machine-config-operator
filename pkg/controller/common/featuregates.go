...
// GCP -> FeatureGateManagedBootImages (opt-out)
// AWS -> FeatureGateManagedBootImagesAWS (opt-out)
// vSphere -> FeatureGateManagedBootImagesvSphere (opt-in)
// Azure -> FeatureGateManagedBootImagesAzure (opt-in)
