...
func (l *LayeredPoolState) GetOSImage() string {
	osImage := l.pool.Annotations[constants.ExperimentalNewestLayeredImageEquivalentConfigAnnotationKey]
	return osImage
}
...
func (l *LayeredPoolState) HasOSImage() bool {
	val, ok := l.pool.Annotations[constants.ExperimentalNewestLayeredImageEquivalentConfigAnnotationKey]
	return ok && val != ""
}
