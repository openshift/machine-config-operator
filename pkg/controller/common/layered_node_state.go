...
func (l *LayeredNodeState) IsDone(mcp *mcfgv1.MachineConfigPool, layered bool, mosc *mcfgv1.MachineOSConfig, mosb *mcfgv1.MachineOSBuild) bool {
	...
	return l.IsNodeDone() && l.IsDesiredMachineConfigEqualToPool(mcp) && !l.IsCurrentImageAnnotationPresentOnNode()
}
...
//
// This augments this check by determining if the desired image annotation is
// equal to what the pool expects.
func (l *LayeredNodeState) IsUnavailable() bool {
...
func (l *LayeredNodeState) IsDesiredEqualToBuild(mosc *mcfgv1.MachineOSConfig, mosb *mcfgv1.MachineOSBuild) bool {
	return (mosc != nil && l.isDesiredImageEqualToBuild(mosc)) && (mosb != nil && l.isDesiredMachineConfigEqualToBuild(mosb))
}
...
func (l *LayeredNodeState) IsDesiredImageAnnotationPresentOnNode() bool {
	_, desiredOK := l.node.Annotations[daemonconsts.DesiredImageAnnotationKey]
	return desiredOK
}
...
func (l *LayeredNodeState) IsCurrentImageAnnotationPresentOnNode() bool {
	_, desiredOK := l.node.Annotations[daemonconsts.CurrentImageAnnotationKey]
	return desiredOK
}
