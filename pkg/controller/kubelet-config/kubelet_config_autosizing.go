...
const (
	// AutoSizingEnvFilePath is the path where the auto-sizing environment file is stored
	AutoSizingEnvFilePath = "/etc/node-sizing-enabled.env"

	// AutoSizingMachineConfigNamePrefix is the prefix for auto-sizing MachineConfig names
...
func (ctrl *Controller) createAutoSizingMachineConfigIfNeeded(pool *mcfgv1.MachineConfigPool) error {
