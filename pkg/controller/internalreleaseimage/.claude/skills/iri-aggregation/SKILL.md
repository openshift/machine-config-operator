  ---                                                                                                                                                                        
  name: verify-iri-aggregation                                                                                                                                               
  description: Verify IRI aggregation code against CSV acceptance criteria. Use when reviewing IRI aggregation changes or validating scenarios.                              
  disable-model-invocation: true                                                                                                                                             
  allowed-tools: Read Grep                                  
  ---

  # Verify IRI Aggregation Against Acceptance Criteria

  Verify that the InternalReleaseImage aggregation implementation correctly handles all acceptance criteria defined in the CSV test scenarios.
