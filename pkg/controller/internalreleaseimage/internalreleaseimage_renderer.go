...
func NewRendererByRole(role string, iri *mcfgv1alpha1.InternalReleaseImage, iriSecret, iriRegistryCredentialsSecret *corev1.Secret, cconfig *mcfgv1.ControllerConfig, tlsProfile *configv1.TLSSecurityProfile) *Renderer {
	return &Renderer{
		role:                         role,
		iri:                          iri,
		iriSecret:                    iriSecret,
