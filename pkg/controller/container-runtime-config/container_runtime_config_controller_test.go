...
func (f *fixture) verifyCRIOCredentialProviderConfigContents(t *testing.T, mcName string, criocp *apicfgv1alpha1.CRIOCredentialProviderConfig) {
...
func TestCrioCredentialProviderConfigCreate(t *testing.T) {
	for _, platform := range []apicfgv1.PlatformType{apicfgv1.AWSPlatformType} {
		t.Run(string(platform), func(t *testing.T) {
			...
			f.verifyCRIOCredentialProviderConfigContents(t, mcs.Name, criocp)
		})
	}
}
...
func TestCrioCredentialProviderConfigUpdate(t *testing.T) {
	for _, platform := range []apicfgv1.PlatformType{apicfgv1.AWSPlatformType} {
		t.Run(string(platform), func(t *testing.T) {
			...
			f.verifyCRIOCredentialProviderConfigContents(t, mcs.Name, criocpUpdate)
