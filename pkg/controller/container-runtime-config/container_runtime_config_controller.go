...
func (ctrl *Controller) cleanUpDuplicatedMC() error {
	...
	for _, mc := range mcList.Items {
		...
		if mc.Annotations[ctrlcommon.GeneratedByControllerVersionAnnotationKey] != version.Hash {
			...
			klog.Infof("Deleting CRC MC: %s since it's generated by controller version: %w does not match: %w", mcToBeDeleted.Name, mcToBeDeleted.Annotations[ctrlcommon.GeneratedByControllerVersionAnnotationKey], version.Hash)
