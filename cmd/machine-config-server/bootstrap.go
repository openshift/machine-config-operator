...
func init() {
	...
	bootstrapCmd.PersistentFlags().StringVar(&bootstrapOpts.serverBaseDir, "server-basedir", "/etc/cluster-config", "base directory on the host, relative to which machine-configs and pools can be found.")
