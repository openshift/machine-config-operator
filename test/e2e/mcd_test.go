...
func TestFirstBootHasSSHKeys(t *testing.T) {
	...
	out1 := helpers.ExecCmdOnNode(t, cs, *newNode, "ls", "-ltr", "/home/core/.ssh")
	t.Logf("## Content of /home/core/.ssh: %s", out1)
	out2 := helpers.ExecCmdOnNode(t, cs, *newNode, "ls", "-ltr", "/home/core/.ssh/authorized_keys.d")
	t.Logf("## Content of /home/core/.ssh/authorized_keys.d: %s", out2)
