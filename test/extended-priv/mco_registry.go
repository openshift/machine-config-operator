...
var _ = g.Describe("[sig-mco][Suite:openshift/machine-config-operator/longduration][Serial][Disruptive] MCO Registry", func() {
	...
	g.It("[PolarionID:57595][OTP][OnCLayer] Use empty pull-secret[Disruptive]", func() {
		var (
	...
	g.It("[PolarionID:66046][OTP][OnCLayer] Check image registry certificates", func() {
	...
	g.It("[PolarionID:68736][OTP][OnCLayer] machine config server supports bootstrap with IR certs [Serial]", func() {
		var (
