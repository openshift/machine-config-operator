...
.ensure-go-bindata:
	cd $(TMP_GOPATH) && git clone https://github.com/jianzhangbjz/go-bindata.git && cd $(TMP_GOPATH)/go-bindata && export GO111MODULE=on && export GOBIN=$(TMP_GOPATH)/bin && go install ./...
