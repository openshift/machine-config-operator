...
replace (
	github.com/openshift/api => github.com/haircommander/api v0.0.0-20250317162801-59c2758a5920
	github.com/openshift/library-go => github.com/haircommander/library-go v0.0.0-20250317181319-f721b99a696b
