...
replace (
	// cluster-api requires tablewriter v1.x for its own CLI tools, but none of those packages
	// are imported by MCO. Pin back to v0.0.5 to keep golangci-lint's revive formatter building.
