...
replace (
	...
	github.com/openshift/api => github.com/RishabhSaini/api v0.0.0-20250818182317-e1c17ac8df4a
	github.com/openshift/api v3.9.0+incompatible => github.com/RishabhSaini/api v0.0.0-20250818182317-e1c17ac8df4a
