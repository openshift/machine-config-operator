...
replace github.com/openshift/api => github.com/cdoern/api v0.0.0-20230929195438-dbe29e047d26

replace github.com/openshift/client-go => github.com/cdoern/client-go v0.0.0-20230929201510-518866505f27
