...
replace github.com/openshift/api => github.com/yuqi-zhang/api v0.0.0-20241213150823-6594c3440ae4

replace github.com/openshift/client-go => github.com/yuqi-zhang/client-go v0.0.0-20241213152247-7d7017524fb3
