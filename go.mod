...
replace (
	github.com/openshift/api => github.com/hexfusion/api v0.0.0-20240125205502-d262ef28f66d
	github.com/openshift/client-go => github.com/hexfusion/client-go v0.0.0-20240125213357-957c2c9950e9
