...
replace github.com/openshift/api => github.com/yuqi-zhang/api v0.0.0-20241219161354-09629e5e9a03

replace github.com/openshift/client-go => github.com/yuqi-zhang/client-go v0.0.0-20241219180828-28677de6d0c1
