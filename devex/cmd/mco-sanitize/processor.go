...
func newFileProcessor(redactor Redactor) *fileProcessor {
	return &fileProcessor{redactor: redactor}
}

func (fp *fileProcessor) Filter(path string) (bool, error) {
...
func (p *fileProcessor) Process(_ context.Context, path string) (bool, error) {
	unmarshaller, marshaller := getMarshallers(path)
...
func getMarshallers(path string) (contentUnMarshaller, contentMarshaler) {
