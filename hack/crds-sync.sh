...
cp "vendor/github.com/openshift/api/machineconfiguration/v1/0000_80_controllerconfig-Default.crd.yaml" "manifests/controllerconfig.crd.yaml"
...
cp "../api/operator/v1/0000_80_machine-config-operator_01_config-TechPreviewNoUpgrade.crd.yaml" "install/0000_80_machine-config-operator_01_config-TechPreviewNoUpgrade.crd.yaml"
cp "../api/operator/v1/0000_80_machine-config-operator_01_config-TechPreviewNoUpgrade.crd.yaml" "manifests/0000_80_machine-config-operator_01_config-TechPreviewNoUpgrade.crd.yaml"
